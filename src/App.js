    ...
    <div className="home-container">
      ...
      {stats && (
        <div className="statistic-float-box">
          ...
          <p>
            <strong>🆓 Bo‘sh xonalar soni:</strong> {stats.availableRooms} ta
          </p>
          <p>
            ...
            <div className="available-rooms">
              ...
              <ul>
                {stats.availableRoomsList.map((room, idx) => (
                  <li key={idx}>
                    🛏 Xona {room.number} — Sig‘imi: {room.capacity} — Hozir
                    band: {room.guests?.length || 0} kishi
                  </li>
                ))}
              </ul>
            </div>
          ...
          {/* 🗓 Oylik Statistika */}
          {monthlyStats && (
            <div className="monthly-stat-box-wrapper">
              <div className="monthly-stat-box centered">
                ...
                {diffRate !== null && (
                  <p>
                    📉 Oldingi oydan farq:{" "}
                    <strong
                      style={{ color: diffRate >= 0 ? "green" : "red" }}
                    >
                      {diffRate > 0 ? "+" : ""}
                      {diffRate}%
                    </strong>
